                  ...
                  {expanded === u.id && (
                    <tr className="bg-gray-50">
                      <td colSpan={6} className="px-5 py-4">
                        ...
                        {/* Current policy — read-only; policies are managed per vehicle in the Vehicles tab */}
                        <div className="border-t border-gray-200 pt-3 mb-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <Link to={`/admin/vehicles?user=${u.id}`}
                              ...
                              <Car className="h-3 w-3" /> Manage per vehicle
                            </Link>
                          </div>
                          {u.policies?.length ? (() => {
                            ...
                            <p className="text-sm text-gray-400">No policy yet — add one for a vehicle in the Vehicles tab.</p>
                          )}
                        </div>
